...
const pricingLinkClass =
  "rounded-lg border border-[#C8A061]/35 bg-[#1F1C18]/80 px-4 py-3 text-left hover:border-[#C8A061]/60 transition-colors";
  ...
  return (
    ...
    >
      ...
      <div className="mt-8 print:hidden max-w-lg mx-auto space-y-2">
        ...
        <p className="text-xs font-bold uppercase tracking-widest text-[#C8A061] text-center mb-3 pt-4">
