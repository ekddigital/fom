...
export const jicfWeddingCertificate: CertificateTemplate = {
  ...
  elements: [
    ...
    },
    {
      ...
      type: "text",
      content:
        "This is to certify that on the 26th day of September, 2026, in Hangzhou, China, Mr. Joshua Bosco Barvor and Miss Ruphine Manaweh Harmon were united in marriage.",
    ...
    },
    {
      ...
      type: "text",
      content: "HUSBAND",
      position: { x: 24, y: 390, width: 196, height: 16 },
      style: {
        fontSize: 11,
        fontFamily: "serif",
        fontWeight: "bold",
    ...
    },
    {
      ...
      position: { x: 24, y: 408, width: 196, height: 44 },
      style: {
        fontSize: 13,
        fontFamily: "serif",
        fontWeight: "bold",
    ...
    },
    {
      ...
      type: "shape",
      content: "",
      position: { x: 36, y: 520, width: 172, height: 2 },
      style: { color: NAVY },
    },
    {
      id: "groom-sign",
      type: "text",
      content: "Signature",
      position: { x: 24, y: 526, width: 196, height: 16 },
      style: {
        fontSize: 11,
        fontFamily: "serif",
        fontStyle: "italic",
    ...
    },
    {
      ...
      type: "text",
      content: "WIFE",
      position: { x: 228, y: 390, width: 200, height: 16 },
      style: {
        fontSize: 11,
        fontFamily: "serif",
        fontWeight: "bold",
    ...
    },
    {
      ...
      position: { x: 228, y: 408, width: 200, height: 48 },
      style: {
        fontSize: 13,
        fontFamily: "serif",
        fontWeight: "bold",
    ...
    },
    {
      ...
      type: "shape",
      content: "",
      position: { x: 244, y: 520, width: 168, height: 2 },
      style: { color: NAVY },
    },
    {
      id: "bride-sign",
      type: "text",
      content: "Signature",
      position: { x: 228, y: 526, width: 200, height: 16 },
      style: {
        fontSize: 11,
        fontFamily: "serif",
        fontStyle: "italic",
    ...
    },
    {
      ...
      position: { x: 436, y: 378, width: 196, height: 16 },
      style: {
        fontSize: 11,
        fontFamily: "serif",
        fontWeight: "bold",
    ...
    },
    {
      ...
      position: { x: 436, y: 396, width: 196, height: 28 },
      style: {
        fontSize: 13,
        fontFamily: "serif",
        fontWeight: "bold",
    ...
    },
    {
      ...
      position: { x: 458, y: 428, width: 150, height: 52 },
      style: {},
    },
    {
      id: "pastor-date",
      ...
      position: { x: 436, y: 482, width: 196, height: 16 },
      style: {
        fontSize: 11,
        fontFamily: "serif",
        color: INK,
    ...
    },
    {
      ...
      type: "shape",
      content: "",
      position: { x: 450, y: 520, width: 168, height: 2 },
      style: { color: NAVY },
    },
    {
      id: "pastor-sign",
      ...
      position: { x: 436, y: 526, width: 196, height: 16 },
      style: {
        fontSize: 11,
        fontFamily: "serif",
        fontStyle: "italic",
    ...
    },
    {
      ...
      type: "text",
      content: "WITNESS 1",
      position: { x: 640, y: 390, width: 160, height: 16 },
      style: {
        fontSize: 11,
        fontFamily: "serif",
        fontWeight: "bold",
    ...
    },
    {
      ...
      type: "shape",
      content: "",
      position: { x: 652, y: 520, width: 136, height: 2 },
      style: { color: NAVY },
    },
    {
      id: "witness-1-sign",
      type: "text",
      content: "Signature",
      position: { x: 640, y: 526, width: 160, height: 16 },
      style: {
        fontSize: 11,
        fontFamily: "serif",
        fontStyle: "italic",
    ...
    },
    {
      ...
      type: "text",
      content: "WITNESS 2",
      position: { x: 808, y: 390, width: 160, height: 16 },
      style: {
        fontSize: 11,
        fontFamily: "serif",
        fontWeight: "bold",
    ...
    },
    {
      ...
      type: "shape",
      content: "",
      position: { x: 820, y: 520, width: 136, height: 2 },
      style: { color: NAVY },
    },
    {
      id: "witness-2-sign",
      type: "text",
      content: "Signature",
      position: { x: 808, y: 526, width: 160, height: 16 },
      style: {
        fontSize: 11,
        fontFamily: "serif",
        fontStyle: "italic",
