...
export const jicfWeddingCertificate: CertificateTemplate = {
  ...
  elements: [
    ...
    },
    {
      ...
      position: { x: 36, y: 376, width: 928, height: 72 },
      style: {
        fontSize: 18,
        fontFamily: "serif",
        fontStyle: "italic",
    ...
    },
    {
      ...
      type: "shape",
      content: "",
      position: { x: 110, y: 456, width: 310, height: 2 },
      style: { color: NAVY },
    },
    {
      id: "husband-caption",
      ...
      position: { x: 90, y: 462, width: 350, height: 20 },
      style: {
        fontSize: 16,
        fontFamily: "serif",
        fontStyle: "italic",
    ...
    },
    {
      ...
      type: "shape",
      content: "",
      position: { x: 110, y: 494, width: 310, height: 2 },
      style: { color: NAVY },
    },
    {
      id: "wife-caption",
      ...
      position: { x: 90, y: 500, width: 350, height: 20 },
      style: {
        fontSize: 16,
        fontFamily: "serif",
        fontStyle: "italic",
    ...
    },
    {
      ...
      type: "shape",
      content: "",
      position: { x: 580, y: 456, width: 310, height: 2 },
      style: { color: NAVY },
    },
    {
      id: "witness-1-sign",
      type: "text",
      content: "(Witness 1)",
      position: { x: 560, y: 462, width: 350, height: 20 },
      style: {
        fontSize: 16,
        fontFamily: "serif",
        fontStyle: "italic",
    ...
    },
    {
      ...
      type: "shape",
      content: "",
      position: { x: 580, y: 494, width: 310, height: 2 },
      style: { color: NAVY },
    },
    {
      id: "witness-2-sign",
      type: "text",
      content: "(Witness 2)",
      position: { x: 560, y: 500, width: 350, height: 20 },
      style: {
        fontSize: 16,
        fontFamily: "serif",
        fontStyle: "italic",
    ...
    },
    {
      ...
      position: { x: 150, y: 524, width: 700, height: 20 },
      style: {
        fontSize: 17,
        fontFamily: "serif",
        color: INK,
    ...
    },
    {
      ...
      position: { x: 200, y: 546, width: 600, height: 20 },
      style: {
        fontSize: 16,
        fontFamily: "serif",
        fontStyle: "italic",
    ...
    },
    {
      ...
      position: { x: 385, y: 566, width: 230, height: 26 },
      style: {},
    },
    {
      id: "pastor-name",
      ...
      position: { x: 180, y: 594, width: 640, height: 20 },
      style: {
        fontSize: 18,
        fontFamily: "serif",
        fontWeight: "bold",
    ...
    },
    {
      ...
      position: { x: 180, y: 614, width: 640, height: 20 },
      style: {
        fontSize: 16,
        fontFamily: "serif",
        fontStyle: "italic",
    ...
    },
    {
      ...
      position: { x: 180, y: 634, width: 640, height: 20 },
      style: {
        fontSize: 16,
        fontFamily: "serif",
        fontWeight: "bold",
